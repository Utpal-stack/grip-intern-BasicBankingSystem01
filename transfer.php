...
<img src="image/transfer.jpg" class="img-fluid" alt="Responsive image" style="width : 100%;  opacity: 0.88; height:100%;">
<div class="glow"><h1 style="font-size:60px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspTransaction</h1></div>
  </div>
</div>
...
$amount  = $rows['amount'];
    ...
    echo'<tr>
      ...
      <td>'.$email.'</td>
      <td>'.$amount.'</td>';
      //  <td><a type="button"  href="transact.php?id='.$id.'&&email2='.$email.'" class="btn btn-success">TRANSACT</a>'
      echo '<td><a type="button"  href="transact.php?id='.$id.'" class="btn btn-success">TRANSACT</a></td>
